...
class Driver {
  ...
  static get traceCategories() {
    return [
      ...
      'disabled-by-default-v8.cpu_profiler',  // these would include JS stack samples, but
      'disabled-by-default-v8.cpu_profiler.hires', // will take the trace from 5MB -> 100MB
